...
import com.donghua.community.service.ElasticsearchService;
...
public class SearchController implements CommunityConstant {
    ...
    public String search(String keyword, Page page, Model model) {
        ...
        // 聚合数据
        List<Map<String, Object>> discuscPosts = new ArrayList<>();
        if (searchResult != null) {
            for (DiscussPost post : searchResult) {
                ...
                map.put("likeCount", likeServicce.findEntityLikeCount(ENTITY_TYPE_POST, post.getId()));
                discuscPosts.add(map);
            }
        }
        model.addAttribute("discussPosts", discuscPosts);
